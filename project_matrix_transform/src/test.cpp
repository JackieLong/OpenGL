...
int main()
{
    ...
    buildTextureData( shaderProgram );
    ...
    renderLoop( window, [&]                         // 渲染循环
    {
        ...
        //loadMatrix1( shaderProgram );
        //loadMatrix2( shaderProgram );
        loadMatrix3( shaderProgram );
...
// 构建第一张图的纹理
void buildTextureData( const ShaderProgram &shaderProgram )
{
    string projDir = projectDir();
